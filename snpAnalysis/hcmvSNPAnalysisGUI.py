            ...
            if self.referenceFileEntry.get() == "Please select a file...." or self.inputFileEntry.get()=="Please select a file...." or self.gffFileEntry.get() =="Please select a file...." or self.cdsFileEntry.get()=="Please select a file...." or self.outputFolderEntry.get()=="Please select a folder....":
                ...
                if suffix == "fastq" or suffix == "fq":
                    ...
                    while True:
                        ...
                        os.system(installationDirectory+"resources/trim_galore --paired -q 0  "+read1+" "+read2 + " -o "+sampleTempFolder)
                        ...
                        os.system(installationDirectory+"resources/fastuniq -i "+sampleTempFolder+"/inputFastUniq -t q -o "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_1.fastq -p "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_2.fastq")
                        ...
                        self.logArea.configure(state='disabled')
                        self.logArea.update()
                        os.system(installationDirectory+"resources/prinseq -fastq "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_1.fastq  -fastq2 "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_2.fastq -min_qual_mean 25 -trim_qual_right 30 -trim_ns_right 20  -trim_qual_window 5 -trim_qual_step 1 -min_len 80 -out_bad null -out_good "+sampleName+"_trimmed_dedup_pr")
                        os.system("mv "+sampleName+"_trimmed_dedup_pr* ./"+sampleTempFolder)
                        os.system("python "+installationDirectory+"snpAnalysis/trimPolyN.py "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_pr_1.fastq "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_pr_2.fastq")
                        ...
                        os.system(installationDirectory+"resources/bowtie2 --end-to-end -1 "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_pr_1.fastq -2 "+sampleTempFolder+"/"+sampleName+"_trimmed_dedup_pr_2.fastq -x "+sampleTempFolder+"/reference -S "+sampleTempFolder+"/"+sampleName+"_alignment.sam -p "+numThreads)
                        ...
                        os.system(installationDirectory+"resources/samtools view -bS -h "+sampleTempFolder+"/"+sampleName+"_alignment.sam > "+sampleTempFolder+"/"+sampleName+"_alignment.bam")
                        ...
                        print "Sorting bam"
                        os.system(installationDirectory+"resources/samtools sort -o "+sampleTempFolder+"/"+sampleName+"_alignment_sorted.bam "+sampleTempFolder+"/"+sampleName+"_alignment.bam")
                        ...
                        if self.dedupChkValue.get()==True:
                            ...
                            os.system("java -jar -XX:ParallelGCThreads="+str(numThreads)+" "+installationDirectory+"resources/picard.jar  AddOrReplaceReadGroups I="+sampleTempFolder+"/"+sampleName+"_alignment_sorted.bam O="+sampleTempFolder+"/"+sampleName+"_rg_added_sorted.bam SO=coordinate RGID=id RGLB=library RGPL=Ilumina RGPU=machine RGSM=Consensus")
                            os.system("java -jar -XX:ParallelGCThreads="+str(numThreads)+" "+installationDirectory+"resources/picard.jar MarkDuplicates I="+sampleTempFolder+"/"+sampleName+"_rg_added_sorted.bam O="+sampleTempFolder+"/"+sampleName+"_markedDuplicates.bam CREATE_INDEX=true VALIDATION_STRINGENCY=SILENT M="+sampleTempFolder+"/output.metrics")
                        ...
                        os.system(installationDirectory+"resources/lofreq call -q "+str(self.BaseQualEntry.get())+" -Q "+str(self.BaseQualEntry.get()) +" -f "+referenceFile+" -o "+sampleTempFolder+"/"+sampleName+"_SNPs.vcf "+sampleTempFolder+"/"+sampleName+"_markedDuplicates.bam")
                        ...
                        os.system("python "+installationDirectory+"snpAnalysis/polyAn.py "+sampleTempFolder+"/vcfFilesToExamine"+" "+self.cdsFileEntry.get()+" "+self.gffFileEntry.get())
