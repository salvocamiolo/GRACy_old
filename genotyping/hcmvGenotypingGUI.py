...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.OutputFileLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
        ...
        self.OutputFileButton = tk.Button(top,command=openOutputFolder,background="#204949",foreground="white")
        ...
        self.dblabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
        ...
        self.changeDB = tk.Button(top,background="#204949",foreground="white")
        ...
        self.CutoffLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
