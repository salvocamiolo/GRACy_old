...
if qualityFiltering == "yes" or qualityFiltering == "Yes":
    ...
    qualConfFile.close()
    os.system("python /home3/scc20x/Software/mySoftware/hqFiltering//run.py ./scripts/qualityFiltering.conf")
...
if denovoAssembly == "yes" or denovoAssembly=="Yes":
    ...
    os.system("python /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/getBestAssembly.py ./1_cleanReads/"+projectName+"_hq_1.fastq ./1_cleanReads/"+projectName+"_hq_2.fastq assemblyStatistics.txt")
...
if performScaffolding == "yes" or performScaffolding == "Yes":
    ...
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/retrieveNodes.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/getSequenceFromFasta.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds_careful.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds_trivial.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/biomodule.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/sequence_a.fasta ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/sequence_a_prime.fasta ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/createCenterScaffold.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/merlinGenome_190000_200000_f.txt ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/extractSeqByRange.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/gapPrediction.py ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/hcmv_genomes.fasta* ./3_scaffoldsOrientation/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/gapfillerlibrary ./3_scaffoldsOrientation/")
    ...
    #os.system("scaffold_builder_v2.py -q ../2_spadesAssembly/scaffolds.fasta -r /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/truncatedReference.fasta -p sb")
    #os.system("head -2 sb_Scaffold.fasta >longestScaffold.fasta")
    os.system("python gapPrediction.py longestScaffold.fasta ../1_cleanReads/"+projectName+"_hq_1.fastq ../1_cleanReads/"+projectName+"_hq_2.fastq")
...
if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
    ...
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinConsensus.py ./4_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/hcmvConsensusCallPipeline ./4_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/bowtiePE ./4_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/createConsensus ./4_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/extractSeqByRange.py ./4_createConsensus")
    os.chdir("4_createConsensus")
    #os.system("./hcmvConsensusCallPipeline "+projectName)
...
if refineAssembly == "yes" or refineAssembly == "Yes":
    ...
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds_careful.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinScaffolds_trivial.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/refineAssembly.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/biomodule.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/maskLowCoverage.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/bowtiePE ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/bwaPE ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/cleanSoftAndUnmapped.py ./5_refineAssembly/")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/sequence_a.fasta ./5_refineAssembly/")
    os.chdir("5_refineAssembly")
    os.system("python refineAssembly.py ../1_cleanReads/"+projectName+"_hq_1 ../1_cleanReads/"+projectName+"_hq_2")
...
if perform2ndConsensusCalling == "yes" or perform2ndConsensusCalling == "Yes":
    ...
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/joinConsensus.py ./6_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/hcmvConsensusCallPipeline ./6_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/bowtiePE ./6_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/createConsensus ./6_createConsensus")
    os.system("cp /home3/scc20x/Software/mySoftware/cytomegaloAssemblerScripts2/extractSeqByRange.py ./6_createConsensus")
