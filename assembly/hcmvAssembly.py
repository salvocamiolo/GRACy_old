...
class Toplevel1:
    def __init__(self, top=None):
        ...
        def bwaPE(reference,read1,read2,alName,numThreads,editDist):
            ...
            os.system(installationDirectory+"resources/bwa aln "+reference+" "+read2+" -t "+numThreads+" -n "+editDist+" -k "+editDist+" >read2.sai 2>null")
            os.system(installationDirectory+"resources/bwa sampe "+reference+" read1.sai read2.sai "+read1+" "+read2+" >"+alName+".sam 2>null")
            os.system(installationDirectory+"assembly/scripts/cleanSoftAndUnmapped.py "+alName+".sam")
            os.system(installationDirectory+"resources/samtools view -bS "+alName+".sam_cleaned.sam > "+alName+".bam 2>null")
            os.system(installationDirectory+"resources/samtools sort -o "+alName+"_sorted.bam "+alName+".bam >null 2>&1")
            os.system(installationDirectory+"resources/samtools index "+alName+"_sorted.bam >null 2>&1")
        ...
        def performAssembly():
            ...
            while True:
                ...
                if qualityFiltering == "yes" or qualityFiltering == "Yes":
                    ...
                    self.logArea.configure(state='disabled')
                    self.logArea.update()
                    os.system("python "+installationDirectory+"assembly/scripts/runQualityFiltering.py qualityFiltering.conf "+installationDirectory)
                ...
                if denovoAssembly == "yes" or denovoAssembly=="Yes":
                    ...
                    self.logArea.update()
                    now = datetime.datetime.now()
                    os.system("python "+installationDirectory+"assembly/scripts/getBestAssembly.py ./1_cleanReads/"+projectName+"_hq_1.fastq ./1_cleanReads/"+projectName+"_hq_2.fastq assemblyStatistics.txt "+installationDirectory)
                ...
                if performScaffolding == "yes" or performScaffolding == "Yes":
                    ...
                    os.system("cp "+installationDirectory+"assembly/scripts/retrieveNodes.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/getSequenceFromFasta.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/joinScaffolds_careful.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/joinScaffolds_trivial.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/joinScaffolds.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/biomodule.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/sequence_a.fasta ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/sequence_a_prime.fasta ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/createCenterScaffold.py ./3_scaffoldsOrientation/")
                    os.system("cp "+installationDirectory+"assembly/scripts/merlinGenome_190000_200000_f.txt ./3_scaffoldsOrientation/")
                ...
                if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
                    ...
                    self.logArea.configure(state='disabled')
                    self.logArea.update()
                    os.system("cat finalScaffold_1_15001_f.txt | "+installationDirectory+"resources/bcftools consensus output.vcf_filtered.vcf.gz > finalScaffold_1_15001_f.txt_con.fasta 2>null")
                    ...
                    self.logArea.configure(state='disabled')
                    self.logArea.update()
                    os.system("cat finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt | "+installationDirectory+"resources/bcftools consensus output.vcf_filtered.vcf.gz > finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt_con.fasta 2>null")
        ...
        self.runButton = tk.Button(top,command=performAssembly)
        self.runButton.place(x=550,y=510,width=100,height=30)
        ...
        self.logFileLabel.place(x=20,y=120,height=20,width=100)
        self.logFileLabel.configure(text="Log window")

        self.logFrame = tk.Frame(top)
        self.logFrame.place(x=20, y=140, height=440, width=520)
        ...
        self.logArea.place(x=25,y=145,height=430, width=510)
