        ...
        def performAssembly():
            ...
            while True:
                ...
                if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
                    ...
                    os.system(installationDirectory+"/resources/lofreq call-parallel --pp-threads "+self.threadsEntry.get()+" -q 30 -Q 30  -f finalScaffold_1_15001_f.txt -o output.vcf dedupped.bam")
                    ...
                    os.system(installationDirectory+"/resources/lofreq call-parallel --pp-threads "+self.threadsEntry.get()+" -q 30 -Q 30  -f finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt -o output.vcf dedupped.bam")
                    os.system("python "+installationDirectory+"resources/getMajorAllele.py output.vcf output_filtered.vcf >null 2>&1")
                    os.system(installationDirectory+"resources/vcf-sort output_filtered.vcf >temp.vcf ; mv temp.vcf output_filtered.vcf")
                    os.system(installationDirectory+"resources/bgzip -c output_filtered.vcf > output_filtered.vcf.gz 2>null")
                    os.system(installationDirectory+"resources/tabix output_filtered.vcf.gz >null 2>&1")
                    ...
                    os.system(installationDirectory+"/resources/lofreq call-parallel --pp-threads "+self.threadsEntry.get()+" -q 30 -Q 30  -f finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt -o output.vcf dedupped.bam")
                    os.system("python "+installationDirectory+"resources/getMajorAllele.py output.vcf output_filtered.vcf >null 2>&1")
                    os.system(installationDirectory+"resources/vcf-sort output_filtered.vcf >temp.vcf ; mv temp.vcf output_filtered.vcf")
                    os.system(installationDirectory+"resources/bgzip -c output_filtered.vcf > output_filtered.vcf.gz 2>null")
                    os.system(installationDirectory+"resources/tabix output_filtered.vcf.gz >null 2>&1")
