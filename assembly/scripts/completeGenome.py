...
os.system("rm -rf sb*")
os.system("python "+installationDirectory+"resources/scaffold_builder_v2.py -q allSequences.fasta -r merlinGenome_1_20000_f.txt -p sb")
...
if os.path.isfile("sb_Scaffold.fasta")==True:
    ...
    os.system("makeblastdb -dbtype nucl -in fivePrimeEnd_scaffold.fasta")
    os.system("blastn -query sequence_trl.fasta -db fivePrimeEnd_scaffold.fasta  -task blastn -outfmt 6 -out outputBlast1a.txt")
...
os.system("rm -rf sb*")
os.system("python "+installationDirectory+"resources/scaffold_builder_v2.py -q allSequences.fasta -r merlinGenome_215000_235646_f.txt -p sb")
...
if os.path.isfile("sb_Scaffold.fasta")==True:
    ...
    os.system("makeblastdb -dbtype nucl -in threePrimeEnd_scaffold.fasta")
    os.system("blastn -query sequence_irs.fasta -db threePrimeEnd_scaffold.fasta  -task blastn -outfmt 6 -out outputBlast1b.txt")
