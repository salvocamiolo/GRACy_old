...
for b in range(2):
    for a in range(int(numReads*0.1),int(numReads*0.9),int(numReads*0.2)):
        ...
        os.system(installationDirectory+"resources/SPAdes-3.12.0-Linux/bin/spades.py -s subsample_1.fq  --cov-cutoff auto --careful -k 53,63,73,83 -o outputSpades_"+str(a)+"_"+str(b) +" >null 2>&1")
        longestScaffold = 0
